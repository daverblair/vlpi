...
from vlpi.FCLayers import FCLayers,FCLayers_Monotonic
from vlpi.LinearPositiveWeights import LinearPositiveWeights
from vlpi.utils import build_onehot_arrays,random_catcov
...
class NonlinearMLPDecoder(nn.Module):
    def __init__(self,nInputDim:int,nCatCovList:Iterable[int],nOutputDim:int,dropLinearCovariateColumn:bool,coupleCovariates:bool,n_layers:int=2,n_hidden:int=128,dropout_rate:float=0.1,use_batch_norm:bool=True):
        """
...
class NonlinearMLPDecoder_Monotonic(nn.Module):
    def __init__(self,nInputDim:int,nCatCovList:Iterable[int],nOutputDim:int,dropLinearCovariateColumn:bool,n_layers:int=2,n_hidden:int=128,dropout_rate:float=0.1,use_batch_norm:bool=False):
        """

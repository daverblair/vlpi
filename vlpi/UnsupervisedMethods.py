...
if __name__=='__main__':
    ...
    simulator = ClinicalDataSimulator(nObsDis,nLatentDim,sparsityRate = 0.0,latentPhenotypeEffectsPrior=[5.0,10.0],anchorDxNoisePrior=[1.0,10.0],interceptPriors=[-3.0,1.0],anchorDxThresholdPrior=[0.001,0.01])
